...
namespace ApplicationinCompany.Migrations
{
    ...
    [Migration("20220609093931_tointtitlesub")]
    partial class tointtitlesub
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheModels.Models.BuildingCost", b =>
                {
                    ...
                    b.Property<bool>("DoneRequistTax")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("TheModels.Models.Company", b =>
                {
                    ...
                    b.Property<string>("IDCompanyApi")
                        .HasMaxLength(200)
                        .HasColumnType("varchar(200)");
                    ...
                    b.Property<string>("NameCompanyEng")
                        .IsRequired()
                        .HasMaxLength(35)
                        .HasColumnType("varchar(35)");

                    b.Property<string>("NumberCommercialRecord")
                        .HasMaxLength(70)
                        .HasColumnType("varchar(70)");

                    b.Property<string>("NumberTax")
                        .HasMaxLength(70)
                        .HasColumnType("varchar(70)");
                    ...
                    b.Property<string>("TitleActivity")
                        .HasMaxLength(70)
                        .HasColumnType("varchar(70)");
            ...
            modelBuilder.Entity("TheModels.Models.FinishCost", b =>
                {
                    ...
                    b.Property<float>("PercantOfmaterial")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("TheModels.Models.OtherCompanies", b =>
                {
                    ...
                    b.Property<string>("NumberCommercial")
                        .HasMaxLength(35)
                        .HasColumnType("varchar(35)");

                    b.Property<float>("Persant")
                        .HasColumnType("float");
                    ...
                    b.Property<string>("TheOtherActive")
                        .HasMaxLength(30)
                        .HasColumnType("varchar(30)");
            ...
            modelBuilder.Entity("TheModels.Models.PaymentFinish", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheModels.Models.ThePaymentCost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<int?>("IdBFinishingcost")
                        .HasColumnType("int");

                    b.Property<int?>("IdBuildingcost")
                        .HasColumnType("int");

                    b.Property<decimal>("ManeyPayment")
                        .HasColumnType("decimal(65,30)");
                    ...
                    b.HasIndex("IdBFinishingcost");

                    b.HasIndex("IdBuildingcost");

                    b.ToTable("thepaymentcost");
                });
            ...
            modelBuilder.Entity("TheModels.Models.Materials", b =>
                {
                    b.HasOne("TheModels.Models.OtherCompanies", "Company")
                        .WithMany("Materials")
            ...
            modelBuilder.Entity("TheModels.Models.PaymentFinish", b =>
                {
                    b.HasOne("TheModels.Models.FinishesUnit", "FinishesUnit")
                        .WithMany("PaymentMoney")
                        .HasForeignKey("IdFinish")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FinishesUnit");
                });
            ...
            modelBuilder.Entity("TheModels.Models.ThePaymentCost", b =>
                {
                    b.HasOne("TheModels.Models.FinishCost", "Finishcost")
                        .WithMany("ManeyPaymentCosts")
                        .HasForeignKey("IdBFinishingcost");

                    b.HasOne("TheModels.Models.BuildingCost", "Buildingcost")
                        .WithMany("ManeyPaymentCosts")
                        .HasForeignKey("IdBuildingcost");

                    b.Navigation("Buildingcost");

                    b.Navigation("Finishcost");
                });
            ...
            modelBuilder.Entity("TheModels.Models.BuildingCost", b =>
                {
                    b.Navigation("ManeyPaymentCosts");
                });
            ...
            modelBuilder.Entity("TheModels.Models.OtherCompanies", b =>
                {
                    ...
                    b.Navigation("RepostsThisCompany");
